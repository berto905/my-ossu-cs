    ...
    for trigger in triggerlist:
        for story in stories:
            if trigger.evaluate(story):
                if story not in relevant_stories:
...
def read_trigger_config(filename):
    ...
    for line in lines:
        ...
        if t[0] != 'ADD':
            if t[1] == 'NOT':
                triggers[t[0]] = trigger_dict['NOT'](triggers[t[2]])
            elif (t[1] == 'AND') or (t[1] == 'OR'):
                triggers[t[0]] = trigger_dict[t[1]](triggers[t[2]], triggers[t[3]])
            else:
...
def main_thread(master):
    ...
    try:
        ...
        # triggerlist = read_trigger_config('debate_triggers.txt') # Problem 12
